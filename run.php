...
$js = json_decode($get_otp);
if ($js->is_user_present == 0){
...
function get_otp($phone_number){
  ...
  curl_setopt($ch, CURLOPT_URL, 'https://api.oyorooms.com/v2/users/generate_otp?phone='.$phone_number.'&nod=4&intent=login&sms_auto_retrieval=false&country_code=%2B62&version=20233&partner_app_version=20233&android_id='.randstr(16).'&idfa='.gen_uuid().'&sid='.randnumber(13).'');
